...
namespace AutoQiangke
{
    ...
    {
        public static IMessageHub RegionSwitchManager = new MessageHub();
        public static IMessageHub SnackbarManager = new MessageHub();
        public static IMessageHub BlockMessager = new MessageHub();
        public static IMessageHub TaskSwitchMessager = new MessageHub();
