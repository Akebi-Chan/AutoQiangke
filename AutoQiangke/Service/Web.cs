...
using static AutoQiangke.Models.WebResult;
...
namespace AutoQiangke.Service
{
    public static class Web
    {
        ...
        public static Dictionary<string, string> PostCommonHeaders()
        {
            ...
            d.Add("Origin", BasicInfo.BaseUri);
            d.Add("Pragma", "no-cache");
            d.Add("Referer", BasicInfo.BaseUri + "/xsxk/zzxkyzb_cxZzxkYzbIndex.html?gnmkdm=N253512&layout=default&su=" + Jac.xh_id);
